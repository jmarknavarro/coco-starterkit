...
<head>
    ...
    <link href="/coco/resource/css/jquery.signature.css" rel="stylesheet">
...
<body>
    ...
    <script src="/coco/resource/js/jquery.signature.min.js"></script>
    ...
    $(document).ready(function() {
        ...
        $('.crop_image').click(function(event) {
            $image_crop.croppie('result', {
                ...
                $.ajax({
                    url: "/coco/settings/updatepropic.php",
                    type: "POST",
                    data: {
                        "image": response
                    },
