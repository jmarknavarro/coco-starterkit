                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="page-title text-dark font-weight-medium">Change Password</br></h4>
                                        <h6 class="text-muted">It's a good idea to use a strong password that you don't
                                            use somewhere.</h6>
                                        <hr>
                                </div>
                                <div class="row ">
                                                ...
                                                <div class="col-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="password_current"
                                                            id="password_current" value="" autocomplete="off" required
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                ...
                                                <div class="form-actions mt-5">
                                                    <div class="text-right">
                                                        <a class="btn btn-outline-secondary mx-1"
                                                            href="./changepassword">Cancel</a>

                                                        <button type="submit" name="success" class="btn btn-info">Change
                                                            Password</button>
                                                    </div>
                                                </div>
                                            </div>
