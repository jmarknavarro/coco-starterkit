                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow active"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line in">
                                <li class="sidebar-item active"><a href="/coco-starterkit/dashboard/instructor/cog"
                                        class="sidebar-link active"><span class="hide-menu">
                                        Completion Grades <br> Within the Semester
                                        </span></a>
                                </li>

                                <li class="sidebar-item"><a href="/coco-starterkit/dashboard/instructor/cogp/"
                                        class="sidebar-link">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-dark font-weight-medium mb-1">Faculty Report on Completion Grades Within the Semester </h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="/coco-starterkit/dashboard/instructor/cog/"
                        ...
                        <h4 class="card-title">New Transaction</h4>
                            ...
                            <div class="card-body">
                                ...
                                <form id="user-form" enctype='multipart/form-data' action="" method="POST">
                                    <?php transCOG();?>
                                    <?php $transid = 'COG'.generateRandomString();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="class_code" id="class_code" style="text-transform: uppercase;"
                                                        class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="school_year" id="school_year"
                                                        class="form-control" placeholder="1234-5678" maxlength="9" oninput="this.value = this.value.replace(/[^0-9.-]/g, '').replace(/(\..*)\./g, '$1');"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="col-form-label">Term</label>
                                                    <select class="form-control" value="<?php echo input::get('ter');?>"
                                                        name="ter">
                                    ...
                                    <div class="form-actions mt-5">
                                        <div class="text-right">
                                            ...
                                            <a class="btn btn-outline-secondary mx-1"
                                                href="/coco-starterkit/dashboard/instructor/cog">Cancel</a>
