    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item active"><a href="/coco-starterkit/dashboard/instructor/cogp/"
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-right mb-4"> <a class="btn text-center text-white btn-info btn-sm1"
                                href="add-transaction"><i data-feather="plus" class="feather-icon mr-1"></i> New
                                Transaction</a></div>
                        <div class="card">
                            <div class="card-body">
                                <div id="message"></div>
                                ...
                                <div class="table-responsive mt-2 mb-3">
                                    <table id='list_transaction' class='table table-bordered dt-hover'
                                        style="width:100%">
                                        <?php
                                        $user_id = $user->data()->id;
                                        $viewtable = new viewtable();
                                        $viewtable->viewTransactionCOGP($user_id);
                                        ?>
                                    </table>
                                </div>
                            </div>
