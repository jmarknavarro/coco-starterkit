...
<head>
    ...
    <title>Faculty Report on Completion of Grades</title>
    <!-- Custom CSS -->
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="/coco-starterkit/dashboard/instructor/cog/"
                                        class="sidebar-link"><span class="hide-menu">  Completion Grades <br> Within the Semester
                                        </span></a>
                                </li>
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link sidebar-link active"
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-dark font-weight-medium mb-1">Faculty Report on
                            Completion of Grades
                        </h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="/coco-starterkit/dashboard/instructor/logs"
                            ...
                            <div class="card-body">
                                <div class="table-responsive mt-2">
                                    ...
                                    ?>
                                        ...
                                        <?php if ($docu->status === 'SUBMITTED') {
        echo ' <a class="btn text-center text-white btn-info btn-sm mb-2" href="add-student?id='.$id.'&classcode='.$clcode.'"><i  data-feather="plus" class="feather-icon"></i> New Students</a>';} ?>
                                    </div>
                                    <table id='list_grades' class='table table-sm v-middle table-bordered dt-hover mt-2'
                                        ...
                                        $viewtable->viewAllStudents($id,$clcode,$user_id);
                                        ?>
                                    </table>
                                </div>
                            </div>
