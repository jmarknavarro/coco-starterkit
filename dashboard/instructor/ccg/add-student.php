                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="student_name" id="student_name"
                                                        ...
                                                        required value="<?php echo input::get('student_name');?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="1" id="1" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="2" id="2" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="3" id="3" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Class Participation</label>
                                                    <input type="number" name="4" id="4" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Period Exam</label>
                                                    <input type="number" name="5" id="5" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Period Grade</label>
                                                    <input type="number" name="6" id="6" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="7" id="7" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                        ...
                                        <hr classs="my-4">
                                        <h4 class="heading-small">Corrected Grade</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Class Participation</label>
                                                    <input type="number" name="12" id="12" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                                        value="<?php echo input::get('12');?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Period Exam</label>
                                                    <input type="number" name="13" id="13" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                                        value="<?php echo input::get('13');?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Period Grade</label>
                                                    <input type="number" name="14" id="14" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                                        value="<?php echo input::get('14');?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">Weighted Grade</label>
                                                    <input type="number" name="15" id="15" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                                        value="<?php echo input::get('15');?>" />
                                                </div>
                                            </div>
                                        </div>

                                        <hr classs="my-4">
                                        <h4 class="heading-small">Final Computed Grade</h4>

                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-form-label">1st Period Grade</label>
                                                    <input type="number" name="8" id="8" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="9" id="9" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="10" id="10" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
                                                        pattern="^\d*(\.\d{0,2})?$"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="11" id="11" class="form-control" min="1"
                                                        max="5" onchange="dec(this)" step="0.25"
