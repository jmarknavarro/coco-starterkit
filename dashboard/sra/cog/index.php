                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item active"><a href="/coco-starterkit/dashboard/sra/cog/"
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" style="width:100%">
                                    <div class="tab-pane show active table-responsive mt-2 mb-3" id="pending-cog">
                                        <table id='list_transaction_cog_1' class='table table-bordered dt-hover'
                                            style="width:100%">
                                            <?php
                                        $viewtable = new viewtable();
                                        $viewtable->sraPendingTransactionCOG();
                                        ?>
                                        </table>
                                    </div>
                                    <div class="tab-pane  table-responsive mt-2 mb-3" id="ongoing-cog">
                                        <table id='list_transaction_cog_2' class='table table-bordered dt-hover'
                                            style="width:100%">
                                            <?php
                                        $viewtable = new viewtable();
                                        $viewtable->sraVerifiedTransactionCOG();
                                        ?>
                                        </table>
                                    </div>

                                    <div class="tab-pane table-responsive mt-2 mb-3" id="completed-cog">
                                        <table id='list_transaction_cog_3' class='table table-bordered dt-hover'
                                            style="width:100%">
                                            <?php
                                        $viewtable = new viewtable();
                                        $viewtable->sraCompletedTransactionCOG();
                                        ?>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab-pane table-responsive mt-2 mb-3" id="reject-cog">
                                        <table id='list_transaction_cog_4' class='table table-bordered dt-hover'
                                            style="width:100%">
                                            <?php
                                        $viewtable = new viewtable();
                                        $viewtable->sraRejectedTransactionCOG();
                                        ?>
                                        </table>
                                    </div>
