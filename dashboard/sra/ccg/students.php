...
<head>
    ...
    <title>Faculty Report on Chage/Correction of Grades</title>
    <!-- Custom CSS -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow active"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line in">
                                ...
                                <li class="sidebar-item active"><a href="/coco-starterkit/dashboard/sra/ccg/"
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="/coco-starterkit/dashboard/sra/ccg/"
