                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item active"><a href="/coco-starterkit/dashboard/sra/logs"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive mt-2 mb-3">
                                    <table id='list_transaction_reports_COG' class='table table-bordered dt-hover'
                                        style="width:100%">
                                        <?php
                                        $user_id = $user->data()->id;
                                        $viewtable = new reportstable();
                                        $viewtable->reportsCOG_SRA($user_id);
                                        ?>
                                    </table>
                                </div>
                            </div>
