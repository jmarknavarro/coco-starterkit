                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow active"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line in">
                                <li class="sidebar-item active"><a href="/coco-starterkit/dashboard/sra/reports/cog/" class="sidebar-link active"><span
                                            class="hide-menu">
                                            Completion Grades <br> Within the Semester
                                        </span></a>
                                </li>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="/coco-starterkit/dashboard/sra/reports/cog/" class="text-muted">Transaction List</a>
                                    </li>
