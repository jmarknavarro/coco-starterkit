                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link has-arrow active"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line in">
                                ...
                                <li class="sidebar-item "><a href="/coco-starterkit/dashboard/sra/reports/cogp/"
                                        class="sidebar-link ">
                                        <span class="hide-menu">Completion of Grades <br> (Previous Semester)</span>
                                    </a>
                                </li>
                                <li class="sidebar-item active"><a href="/coco-starterkit/dashboard/sra/reports/ccg/"
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-dark font-weight-medium mb-1">Faculty Report on Chage/Correction of
                            Grades
                        </h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="/coco-starterkit/dashboard/sra/reports/ccg/"
