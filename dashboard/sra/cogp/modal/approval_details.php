            ...
            <div class="modal-body">
                ...
                <div class="container mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5 class="page-title text-dark" id="recommended_4"></h5>
                            <h5 class="page-date" id="recommendeddate_4"></h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-7">
                            ...
                            <h5 class="page-date" id="verifieddate4"></h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).on('click', '.approve_D', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#verifieddate4').text(response.verified_date);
                }
            });
        })
    }
